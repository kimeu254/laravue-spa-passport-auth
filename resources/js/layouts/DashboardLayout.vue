    ...
    <div>
        <div class="wrapper">
            <div class="main-header">
                ...
                <div class="logo-header" data-background-color="primary">
                    ...
                    <button class="navbar-toggler sidenav-toggler ml-auto" type="button" data-bs-toggle="collapse" data-bs-target="collapse" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon">
                            <i class="mdi mdi-menu-open icon-menu"></i>
                        </span>
                    </button>
                    <button class="topbar-toggler more"><i class="mdi mdi-menu-swap-outline icon-options-vertical"></i></button>
                    <div class="nav-toggle">
                        <button class="btn btn-toggle toggle-sidebar">
                            <i class="mdi mdi-backburger icon-menu"></i>
                        </button>
                    </div>
                </div>
                <!-- End Logo Header -->
                ...
                <!-- Navbar Header -->
                <nav class="navbar navbar-header navbar-expand-lg" data-background-color="secondary">
...
export default {
    ...
    created() {
        axios.defaults.headers.common["Authorization"] = "Bearer " + localStorage.getItem("my_token")
    },
    methods:{
        ...mapActions({
            signOut:"auth/logout"
